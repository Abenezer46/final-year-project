...
<body>
    <header class="text-center p-5">
        <p class="display-4">Sells Page</p>
    </header>
    ...
    <div class="p-3 m-0 border-0 bd-example"
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/sells.php?sell=add" class="btn btn-primary">Go to Page</a>
            </div>
        </div>
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/sells.php?sell=update" class="btn btn-primary">Go to Page</a>
            </div>
        </div>
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/sells.php?sell=delete" class="btn btn-primary">Go to Page</a>
            </div>
        </div>
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/sells.php?sell=view" class="btn btn-primary">Go to Page</a>
            </div>
        </div>
