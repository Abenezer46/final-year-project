    ...
    <div class="p-3 m-0 border-0 bd-example"
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/report.php?gen=users" class="btn btn-pri">Generate</a>
            </div>
        </div>
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/report.php?gen=store" class="btn btn-pri">Generate</a>
            </div>
        </div>
        ...
        <div class="card mb-3 text-center shadow" style="display:flex; align-items:center; width: 18rem;">
            ...
            <div class="card-body">
                ...
                <a href="../app/report.php?gen=sells" class="btn btn-pri">Generate</a>
            </div>
        </div>
